...
if (!MONGODB_URI) {
    ...
    console.error('Please set MONGODB_URI in your Render.com Environment Variables (Dashboard > Environment).');
    process.exit(1);
}
...
// --- Single shared handler for GET and POST /app ---
async function appHandler(req, res) {
    try {
        ...
        // 2. Deletion via GET query params
        ...
        // 4. Base data object for GET rendering
        const data = {
            user,
            page,
            success_msg,
